...
{ href: "/dashboard/tasks" as const, label: "Tasks", icon: SquareKanban },
{ href: "/dashboard/analytics" as const, label: "Analytics", icon: BarChart3 },
{ href: "/dashboard/team" as const, label: "Team", icon: Users },
...
<Sparkles className="h-5 w-5" />
    ...
    <div className="rounded-3xl bg-gradient-to-br from-sky-500 to-violet-600 p-5 text-white shadow-soft">
      ...
      <p className="mt-2 text-sm leading-6 text-white/85">
        Use this build as a client starter, a paid template,
        or the base for your own SaaS.
      </p>
